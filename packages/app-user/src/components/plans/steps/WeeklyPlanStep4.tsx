...
export function WeeklyPlanStep4() {
  const { weeklyEquipment, setWeeklyEquipment, nextStep } = usePlanCreationStore();
    ...
    <div className="space-y-6 max-w-3xl mx-auto">
      ...
      <div className="grid md:grid-cols-3 gap-4">
        {EQUIPMENT_OPTIONS.map((option) => {
          ...
          const isSelected = weeklyEquipment === option.value;
