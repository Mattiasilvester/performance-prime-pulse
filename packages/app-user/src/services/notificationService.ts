...
// TODO: remove partner dependency — type was from @/hooks/usePartnerNotifications
type ProfessionalNotificationType = 'new_booking' | 'booking_confirmed' | 'booking_cancelled' | 'booking_reminder' | 'new_client' | 'new_project' | 'new_review' | 'review_response' | 'custom';
