-- ============================================
-- AGGIUNTA COLONNA: possiede_attrezzatura
-- ============================================
-- Feature: Domanda condizionale "Possiedi attrezzatura?" in Step 3
-- Visibile solo quando utente seleziona "Casa" o "Outdoor"

-- Aggiungi colonna alla tabella unificata
ALTER TABLE user_onboarding_responses
ADD COLUMN IF NOT EXISTS possiede_attrezzatura BOOLEAN DEFAULT NULL;

-- Aggiungi colonna alla tabella vecchia (se esiste)
DO $$
BEGIN
