...
async function testLogging() {
  ...
  const originalDebug = process.env.NEXT_PUBLIC_DEBUG_ANALYSIS;
  process.env.NEXT_PUBLIC_DEBUG_ANALYSIS = "1";
  ...
  // Ripristina debug
  process.env.NEXT_PUBLIC_DEBUG_ANALYSIS = originalDebug;
  console.log('');
}
