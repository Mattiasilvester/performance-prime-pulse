...
class Analytics {
  ...
  constructor() {
    ...
    this.isEnabled = !safeLocalStorage.getItem('analytics_disabled');
    this.init();
  }
  ...
  setEnabled(enabled: boolean) {
    ...
    if (enabled) {
      safeLocalStorage.removeItem('analytics_disabled');
      this.init();
    } else {
      safeLocalStorage.setItem('analytics_disabled', 'true');
    }
  }
