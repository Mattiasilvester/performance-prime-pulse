        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-3 flex-1">
            ...
            <div className="flex-1 min-w-0">
              <h4 className="font-semibold text-white text-base truncate">{exercise.name}</h4>
          ...
          <div className="flex items-center space-x-2 ml-3">
            <Button
              ...
              size="sm"
              className="bg-blue-500 hover:bg-blue-600 text-white px-3 py-2 text-sm h-8"
            >
              Avvia
            </Button>
            <Button
              onClick={onComplete}
              size="sm"
              className="bg-[#EEBA2B] hover:bg-[#d4a61a] text-black px-2 py-2 text-xs font-medium h-8"
