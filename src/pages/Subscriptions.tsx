  ...
  return (
    <div className="min-h-screen bg-black text-white">
      <div className="container mx-auto px-4 py-8">
        ...
        <div 
          className="flex gap-6 overflow-x-auto pb-4 px-4 snap-x snap-mandatory scrollbar-hide justify-center pt-10"
        >
          {plans.map((plan) => (
            <div 
              key={plan.id} 
            ...
            >
              ...
              `}>
                {plan.popular && (
                  <div className="absolute -top-2 right-6 z-10 most-popular-badge">
