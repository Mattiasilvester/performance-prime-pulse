        ...
        <div className="space-y-6">
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6 overflow-hidden">
            ...
            <div className="space-y-0">
              ...
              <div className="flex justify-between items-center py-3 border-b border-gray-100">
                <div className="flex-1 min-w-0">
                  <span className="text-sm text-gray-500">Modalità servizio</span>
                  {editingField === 'modalita' ? (
                    <div className="mt-1">
                      <select
                        autoFocus
                        value={editValue}
                    ...
                    <p className="text-gray-900 break-words mt-1">
                      {profile.modalita === 'presenza' ? 'In presenza' : 
                       profile.modalita === 'online' ? 'Online' : 
                       profile.modalita === 'entrambi' ? 'Entrambe' : profile.modalita}
                    </p>
                  )}
                </div>
                {editingField !== 'modalita' && (
                  <button 
                    onClick={() => startEdit('modalita', profile.modalita)}
                    className="ml-2 p-1 hover:bg-gray-100 rounded transition-colors"
                  >
                    <Pencil className="w-4 h-4 text-gray-400 hover:text-[#EEBA2B] transition-colors" />
                  </button>
