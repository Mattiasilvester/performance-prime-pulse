 ...
 * Esegui con: node test-production.cjs
 */
...
const requiredFiles = [
  'dist/index.html',
  'dist/assets/index-MsEZLVJ0.js',
  'dist/assets/vendor-BPYbqu-q.js',
  'dist/assets/supabase-CBG-_Yjj.js'
];
...
if (totalSizeKB < 100) {
  ...
  console.log('✅ Bundle size accettabile (< 1 MB)');
} else {
  console.log('⚠️ Bundle size grande (> 1 MB)');
}
...
try {
  ...
  const mainJs = fs.readFileSync('dist/assets/index-MsEZLVJ0.js', 'utf8');
